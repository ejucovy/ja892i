...
TYPE_CHOICES = {
    "userfield": (_("Userfield Value"), 
                  "actionkit_usersearch.columns.UserField"),
    "actionfield": (_("Actionfield Value"), 
                    "actionkit_usersearch.columns.ActionField"),
    "num_actions": (_("Number of Actions"), 
                    "actionkit_usersearch.columns.NumActions"),
    "num_donations": (_("Number of Donations"), 
                      "actionkit_usersearch.columns.NumDonations"),
    "total_donations": (_("Total Amount Donated"), 
                        "actionkit_usersearch.columns.TotalDonations"),
    "yearly_donations": (_("Amount Donated Per Year"),
                         "actionkit_usersearch.columns.YearlyDonations"),
    }
